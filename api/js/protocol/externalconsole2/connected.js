...
const Connected = {
	...
	ConsoleMessage: class extends Buffer {
		 ...
		 * @param commandId
		 *        Identifier given in {Command.commandId} if the log was generated by a command sent by the external
	...
	Command: class extends Buffer {
		 ...
		 * @param commandId
		 *        Identifier for the command that will be sent in {ConsoleMessage.commandId} if the command generates
		 *        an output.
		 */
