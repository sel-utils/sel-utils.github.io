...
const Clientbound = {
	...
	EntityEffect: class extends Buffer {
		...
		constructor(entityId=0, effectId=0, amplifier=0, duration=0, showParticles=false) {
			super();
			this.entityId = entityId;
			this.effectId = effectId;
		...
		encode() {
			...
			this.writeBigEndianByte(this.showParticles?1:0);
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			this.duration=this.readVaruint();
			this.showParticles=this.readBigEndianByte()!==0;
			return this;
		}
