 ...
 */
/** @module sul/protocol/minecraft333/types */
...
const Types = {
	...
	Entry: class extends Buffer {
		...
		encode() {
			...
			this.writeBigEndianByte(this.craftingSlot);
			this.writeBigEndianByte(this.playerSlot);
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			this.craftingSlot=this.readBigEndianByte();
			this.playerSlot=this.readBigEndianByte();
			return this;
		}
