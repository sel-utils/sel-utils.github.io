 ...
 */
/** @module sul/protocol/hncom2/player */
...
const Player = {
	...
	UpdateGamemode: class extends Buffer {
		...
		constructor(hubId=0, gamemode=0) {
			super();
			this.hubId = hubId;
		...
		/** @param {(Uint8Array|Array)} buffer */
		static fromBuffer(buffer) {
			return new Player.UpdateGamemode().decode(buffer);
		}
