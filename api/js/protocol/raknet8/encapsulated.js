...
const Encapsulated = {
	...
	ServerHandshake: class extends Buffer {
		...
		encode() {
			...
			for(var dhc5enz1 in this.systemAddresses){ this.writeBytes(this.systemAddresses[dhc5enz1].encode()); }
			this.writeBigEndianLong(this.pingId);
		...
		decode(_buffer) {
			...
			var aramcldv=10; this.systemAddresses=[]; for(var dhc5enz1=0;dhc5enz1<aramcldv;dhc5enz1++){ this.systemAddresses[dhc5enz1]=Types.Address.fromBuffer(this._buffer); this._buffer=this.systemAddresses[dhc5enz1]._buffer; }
			this.pingId=this.readBigEndianLong();
