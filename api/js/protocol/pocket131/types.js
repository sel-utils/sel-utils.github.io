...
const Types = {
	...
	PlayerList: class extends Buffer {
		 ...
		 */
		constructor(uuid=null, entityId=0, displayName="", skin=null, xuid="") {
			super();
			this.uuid = uuid;
		...
		encode() {
			...
			var dhc5dl=this.encodeString(this.xuid); this.writeVaruint(dhc5dl.length); this.writeBytes(dhc5dl);
			return new Uint8Array(this._buffer);
		}
		...
		/** @return {string} */
		toString() {
			return "PlayerList(uuid: " + this.uuid + ", entityId: " + this.entityId + ", displayName: " + this.displayName + ", skin: " + this.skin + ", xuid: " + this.xuid + ")";
		}
