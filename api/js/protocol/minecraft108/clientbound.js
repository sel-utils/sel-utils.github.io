 ...
 */
/** @module sul/protocol/minecraft108/clientbound */
...
const Clientbound = {
	...
	Statistics: class extends Buffer {
		...
		encode() {
			this._buffer = [];
			this.writeVaruint(7);
			this.writeVaruint(this.statistics.length); for(var dhc5dfan in this.statistics){ this.writeBytes(this.statistics[dhc5dfan].encode()); }
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			this._buffer = Array.from(_buffer);
			var _id=this.readVaruint();
			var aramcrdl=this.readVaruint(); this.statistics=[]; for(var dhc5dfan=0;dhc5dfan<aramcrdl;dhc5dfan++){ this.statistics[dhc5dfan]=Types.Statistic.fromBuffer(this._buffer); this._buffer=this.statistics[dhc5dfan]._buffer; }
			return this;
		}
	...
	TabComplete: class extends Buffer {
		...
		encode() {
			...
			this.writeVaruint(this.matches.length); for(var dhc5yrav in this.matches){ var dhc5yrav=this.encodeString(this.matches[dhc5yrav]); this.writeVaruint(dhc5yrav.length); this.writeBytes(dhc5yrav); }
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			this._buffer = Array.from(_buffer);
			var _id=this.readVaruint();
			var arambfyh=this.readVaruint(); this.matches=[]; for(var dhc5yrav=0;dhc5yrav<arambfyh;dhc5yrav++){ this.matches[dhc5yrav]=this.decodeString(this.readBytes(this.readVaruint())); }
			return this;
		}
	...
	MultiBlockChange: class extends Buffer {
		...
		encode() {
			...
			this.writeVaruint(this.changes.length); for(var dhc5afzv in this.changes){ this.writeBytes(this.changes[dhc5afzv].encode()); }
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			var aramyhbd=this.readVaruint(); this.changes=[]; for(var dhc5afzv=0;dhc5afzv<aramyhbd;dhc5afzv++){ this.changes[dhc5afzv]=Types.BlockChange.fromBuffer(this._buffer); this._buffer=this.changes[dhc5afzv]._buffer; }
			return this;
		}
	...
	OpenWindow: class extends Buffer {
		...
		encode() {
			...
			this.writeBigEndianByte(this.window);
			var dhc5eb=this.encodeString(this.type); this.writeVaruint(dhc5eb.length); this.writeBytes(dhc5eb);
			var dhc5arz=this.encodeString(this.title); this.writeVaruint(dhc5arz.length); this.writeBytes(dhc5arz);
	...
	WindowItems: class extends Buffer {
		...
		encode() {
			...
			this.writeBigEndianByte(this.window);
			this.writeBigEndianShort(this.slots.length); for(var dhc5b9c in this.slots){ this.writeBytes(this.slots[dhc5b9c].encode()); }
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			var _id=this.readVaruint();
			this.window=this.readBigEndianByte();
			var aramcxdm=this.readBigEndianShort(); this.slots=[]; for(var dhc5b9c=0;dhc5b9c<aramcxdm;dhc5b9c++){ this.slots[dhc5b9c]=Types.Slot.fromBuffer(this._buffer); this._buffer=this.slots[dhc5b9c]._buffer; }
			return this;
		}
	...
	Explosion: class extends Buffer {
		...
		encode() {
			...
			this.writeBigEndianInt(this.records.length); for(var dhc5zncr in this.records){ this.writeBigEndianByte(this.records[dhc5zncr].x); this.writeBigEndianByte(this.records[dhc5zncr].y); this.writeBigEndianByte(this.records[dhc5zncr].z); }
		...
		decode(_buffer) {
			...
			var aramcvbj=this.readBigEndianInt(); this.records=[]; for(var dhc5zncr=0;dhc5zncr<aramcvbj;dhc5zncr++){ this.records[dhc5zncr]={}; this.records[dhc5zncr].x=this.readBigEndianByte(); this.records[dhc5zncr].y=this.readBigEndianByte(); this.records[dhc5zncr].z=this.readBigEndianByte(); }
	...
	ChangeGameState: class extends Buffer {
		...
		static get PLAY_MOB_APPEARANCE(){ return 10; }
	...
	ChunkData: class extends Buffer {
		...
		constructor(position={x:0,z:0}, full=false, sections=0, data=[]) {
			super();
			this.position = position;
			this.full = full;
		...
		/** @return {string} */
		toString() {
			return "ChunkData(position: " + this.position + ", full: " + this.full + ", sections: " + this.sections + ", data: " + this.data + ")";
		}
	...
	Effect: class extends Buffer {
		...
		static get DOOR_OPEN_OR_CLOSE(){ return 1003; }
		static get FIREWORK_SHOT(){ return 1004; }
		static get PLAY_DISC(){ return 1005; }
		static get GHAST_WARN(){ return 1007; }
		static get GHAST_SHOOT(){ return 1008; }
		static get ZOMBIE_ATTACK_WOOD_DOOR(){ return 1010; }
		static get ZOMBIE_ATTACK_IRON_DOOR(){ return 1011; }
		static get ZOMBIE_BREAK_WOOD_DOOR(){ return 1012; }
		static get WITHER_SPAWN(){ return 1013; }
		static get WITHER_SHOOT(){ return 1014; }
		static get BAT_TAKE_OFF(){ return 1015; }
		static get ZOMBIE_INFECT_VILLAGER(){ return 1016; }
		static get ZOMBIE_VILLAGER_CONVERT(){ return 1017; }
		static get ANVIL_BREAK(){ return 1019; }
		static get ANVIL_USE(){ return 1020; }
		static get ANVIL_LAND(){ return 1021; }
		static get SPAWN_10_SMOKE_PARTICLES(){ return 2000; }
		static get BREAK_BREAK_PARTICLES(){ return 2001; }
	...
	Particle: class extends Buffer {
		...
		encode() {
			...
			for(var dhc5zrdl in this.additionalData){ this.writeVaruint(this.additionalData[dhc5zrdl]); }
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			var aramyrar=2; this.additionalData=[]; for(var dhc5zrdl=0;dhc5zrdl<aramyrar;dhc5zrdl++){ this.additionalData[dhc5zrdl]=this.readVaruint(); }
			return this;
		}
	...
	JoinGame: class extends Buffer {
		...
		encode() {
			...
			var dhc5zzbr=this.encodeString(this.levelType); this.writeVaruint(dhc5zzbr.length); this.writeBytes(dhc5zzbr);
	...
	Map: class extends Buffer {
		...
		encode() {
			...
			this.writeVaruint(this.icons.length); for(var dhc5y9c in this.icons){ this.writeBytes(this.icons[dhc5y9c].encode()); }
		...
		decode(_buffer) {
			...
			var aramanbm=this.readVaruint(); this.icons=[]; for(var dhc5y9c=0;dhc5y9c<aramanbm;dhc5y9c++){ this.icons[dhc5y9c]=Types.Icon.fromBuffer(this._buffer); this._buffer=this.icons[dhc5y9c]._buffer; }
	...
	switch(this.action) {
		...
		decode(_buffer) {
			...
			switch(this.action) {
				case 0:
					var aramcxev=this.readVaruint(); this.players=[]; for(var dhc5bfzj=0;dhc5bfzj<aramcxev;dhc5bfzj++){ this.players[dhc5bfzj]=Types.ListAddPlayer.fromBuffer(this._buffer); this._buffer=this.players[dhc5bfzj]._buffer; }
					break;
				case 1:
					var aramcxev=this.readVaruint(); this.players=[]; for(var dhc5bfzj=0;dhc5bfzj<aramcxev;dhc5bfzj++){ this.players[dhc5bfzj]=Types.ListUpdateGamemode.fromBuffer(this._buffer); this._buffer=this.players[dhc5bfzj]._buffer; }
					break;
				case 2:
					var aramcxev=this.readVaruint(); this.players=[]; for(var dhc5bfzj=0;dhc5bfzj<aramcxev;dhc5bfzj++){ this.players[dhc5bfzj]=Types.ListUpdateLatency.fromBuffer(this._buffer); this._buffer=this.players[dhc5bfzj]._buffer; }
					break;
				case 3:
					var aramcxev=this.readVaruint(); this.players=[]; for(var dhc5bfzj=0;dhc5bfzj<aramcxev;dhc5bfzj++){ this.players[dhc5bfzj]=Types.ListUpdateDisplayName.fromBuffer(this._buffer); this._buffer=this.players[dhc5bfzj]._buffer; }
					break;
				case 4:
	...
	DestroyEntities: class extends Buffer {
		...
		encode() {
			...
			this.writeVaruint(this.entityIds.length); for(var dhc5brdl in this.entityIds){ this.writeVaruint(this.entityIds[dhc5brdl]); }
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			this._buffer = Array.from(_buffer);
			var _id=this.readVaruint();
			var aramz5ar=this.readVaruint(); this.entityIds=[]; for(var dhc5brdl=0;dhc5brdl<aramz5ar;dhc5brdl++){ this.entityIds[dhc5brdl]=this.readVaruint(); }
			return this;
		}
	...
	ResourcePackSend: class extends Buffer {
		...
		encode() {
			...
			var dhc5cw=this.encodeString(this.url); this.writeVaruint(dhc5cw.length); this.writeBytes(dhc5cw);
	...
	DisplayScoreboard: class extends Buffer {
		...
		encode() {
			...
			this.writeBigEndianByte(this.position);
			var dhc5y9z5=this.encodeString(this.scoreName); this.writeVaruint(dhc5y9z5.length); this.writeBytes(dhc5y9z5);
			return new Uint8Array(this._buffer);
		}
	...
	ScoreboardObjective: class extends Buffer {
		...
		encode() {
			...
			if(mode!=1){ var dhc5yxz=this.encodeString(this.value); this.writeVaruint(dhc5yxz.length); this.writeBytes(dhc5yxz); }
			if(mode!=1){ var dhc5eb=this.encodeString(this.type); this.writeVaruint(dhc5eb.length); this.writeBytes(dhc5eb); }
			return new Uint8Array(this._buffer);
		}
	...
	SetPassengers: class extends Buffer {
		...
		encode() {
			...
			this.writeVaruint(this.entityId);
			this.writeVaruint(this.passengers.length); for(var dhc5ynz5 in this.passengers){ this.writeVaruint(this.passengers[dhc5ynz5]); }
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			var _id=this.readVaruint();
			this.entityId=this.readVaruint();
			var aramcfcv=this.readVaruint(); this.passengers=[]; for(var dhc5ynz5=0;dhc5ynz5<aramcfcv;dhc5ynz5++){ this.passengers[dhc5ynz5]=this.readVaruint(); }
			return this;
		}
		...
		decode(_buffer) {
			...
			switch(this.mode) {
				case 0:
					...
					var aramcxev=this.readVaruint(); this.players=[]; for(var dhc5bfzj=0;dhc5bfzj<aramcxev;dhc5bfzj++){ this.players[dhc5bfzj]=this.decodeString(this.readBytes(this.readVaruint())); }
					break;
				case 1:
					break;
				case 2:
	...
	UpdateScore: class extends Buffer {
		...
		encode() {
			...
			var dhc5y9z5=this.encodeString(this.scoreName); this.writeVaruint(dhc5y9z5.length); this.writeBytes(dhc5y9z5);
			this.writeBigEndianByte(this.action);
			var dhc5ypyr=this.encodeString(this.objectiveName); this.writeVaruint(dhc5ypyr.length); this.writeBytes(dhc5ypyr);
	...
	PlayerListHeaderAndFooter: class extends Buffer {
		...
		encode() {
			...
			var dhc5zfzi=this.encodeString(this.header); this.writeVaruint(dhc5zfzi.length); this.writeBytes(dhc5zfzi);
			var dhc5b9zi=this.encodeString(this.footer); this.writeVaruint(dhc5b9zi.length); this.writeBytes(dhc5b9zi);
			return new Uint8Array(this._buffer);
		}
	...
	EntityProperties: class extends Buffer {
		...
		encode() {
			...
			this.writeVaruint(this.entityId);
			this.writeBigEndianInt(this.attributes.length); for(var dhc5draj in this.attributes){ this.writeBytes(this.attributes[dhc5draj].encode()); }
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			var _id=this.readVaruint();
			this.entityId=this.readVaruint();
			var aramyrcl=this.readBigEndianInt(); this.attributes=[]; for(var dhc5draj=0;dhc5draj<aramyrcl;dhc5draj++){ this.attributes[dhc5draj]=Types.Attribute.fromBuffer(this._buffer); this._buffer=this.attributes[dhc5draj]._buffer; }
			return this;
		}
	...
	EntityEffect: class extends Buffer {
		...
		constructor(entityId=0, effectId=0, amplifier=0, duration=0, hideParticles=false) {
			super();
			this.entityId = entityId;
			this.effectId = effectId;
		...
		encode() {
			...
			this.writeBigEndianByte(this.hideParticles?1:0);
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			this.duration=this.readVaruint();
			this.hideParticles=this.readBigEndianByte()!==0;
			return this;
		}
